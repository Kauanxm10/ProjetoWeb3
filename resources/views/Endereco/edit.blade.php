...
<body>
    <div class="container">
        <form method="post" action="{{ route('endereco.update', $endereco->id) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id-input-nome" name="bairro"
                    placeholder="Digite o nome do bairro" value="{{ $endereco->bairro }}">
            </div>
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="id-input-preco" name="logradouro"
                    placeholder="Digite o logradouro do endereco" step=".01" value="{{ $endereco->logradouro }}">
            </div>
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="id-input-numero" name="numero"
                    placeholder="Digite o numero do endereco" step=".01" value="{{ $endereco->numero }}">
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id-input-complemento" name="complemento"
                    placeholder="Digite os complementos do endereco" value="{{ $endereco->complemento }}">
            </div>
            <div class="mb-3">
