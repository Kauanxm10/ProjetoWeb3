...
<body>
    <div class="container">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="id-input-user_id" disabled value="<?php echo e($endereco->Users_id); ?>">
        </div>
        <div class="mb-3">
...
<?php /**PATH C:\Users\alunolages\Documents\Aula 35\ProjetoAula3\resources\views/Endereco/show.blade.php ENDPATH**/ ?>